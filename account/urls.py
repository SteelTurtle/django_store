...
from .views import ActivateAccount, CreateAccount, DisableAccount, ProfileDetail, ProfileUpdate, PublicProfileDetail, \
...
password_urls = [
    url(r'^change/$', auth_views.password_change,
        ...
        name='pw_change'),
    url(r'^change/done/$', auth_views.password_change_done, {'template_name': 'account/password_change_done.html'},
        name='pw_change_done'),
    url(r'^reset/$', auth_views.password_reset, {'template_name': 'account/password_reset_form.html',
                                                 'email_template_name': 'account/password_reset_email.txt',
                                                 'subject_template_name': 'account/password_reset_subject.txt',
                                                 'post_reset_redirect': reverse_lazy('dj-auth:pw_reset_sent')},
        name='pw_reset_start'),
    url(r'^reset/sent/$', auth_views.password_reset_done, {'template_name': 'account/password_reset_sent.html'},
        name='pw_reset_sent'),
...
urlpatterns = [
    ...
    url(r'^create/done/$', TemplateView.as_view(template_name='account/account_create_done.html'),
        name='create_done'),
    ...
    url(r'^logout/$', auth_views.logout, {'template_name': 'account/logged_out.html',
